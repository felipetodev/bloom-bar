...
export default function Custom404 () {
  return (
    <>
      ...
      <Navbar />
      <section className='relative flex flex-col justify-center items-center gap-5 h-[90vh] bg-bloom-darkGreen-100 text-xl sm:text-2xl text-bloom-softGray-100 px-16'>
        ...
        <div className='absolute -bottom-14 right-0 select-none pointer-events-none md:-bottom-2'>
